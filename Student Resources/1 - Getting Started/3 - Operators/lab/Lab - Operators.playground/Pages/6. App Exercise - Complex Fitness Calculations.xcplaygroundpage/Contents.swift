 ...
 */
let heartRate1D=62.0
let heartRate2D=71.0
let heartRate3D=83.0
let averageHR=(heartRate1D+heartRate2D+heartRate3D)/3
print(averageHR)
 ...
 */
 let tempInFahernheit=98.6
 let tempInCelcius=(tempInFahernheit-32)*(5.0/9.0)
 print(tempInCelcius)
