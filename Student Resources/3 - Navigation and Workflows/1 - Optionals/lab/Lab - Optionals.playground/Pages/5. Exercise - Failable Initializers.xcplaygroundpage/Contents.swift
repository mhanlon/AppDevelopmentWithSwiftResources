 ...
 */
let failComputer = Computer(ram: 0, yearManufactured: 1960)
if let computer = failComputer {
    print(computer.ram)
    print(computer.yearManufactured)
}

let succComputer = Computer(ram: 16, yearManufactured: 2010)
if let computer = succComputer {
    print(computer.ram)
    print(computer.yearManufactured)
}
