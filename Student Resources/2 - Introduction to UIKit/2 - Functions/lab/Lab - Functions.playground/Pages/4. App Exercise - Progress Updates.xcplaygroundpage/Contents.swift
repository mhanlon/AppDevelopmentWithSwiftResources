...
func progressUpdate(steps :Int, goal: Int ){
    ...
    let stepsPercentage = Double(steps)/Double(goal)
    if stepsPercentage < 0.1 {
        print("You're off to a good start.")
    } else if stepsPercentage < 0.5 {
        print("You're almost halfway there!")
    } else if stepsPercentage < 0.9 {
...
progressUpdate(steps: 10000, goal: 21000)
...
pacing(currentDistance: 60, totalDistance: 100, currentTime: 3.0, goalTime: 5.0)
