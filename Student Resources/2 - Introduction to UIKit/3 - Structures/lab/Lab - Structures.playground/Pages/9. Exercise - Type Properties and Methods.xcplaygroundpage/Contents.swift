...
struct User {
    ...
    static var currentUser: User = User(userName: "Norah", email: "Norah@example.com", age: 21)
    static func logIn(user: User) {
        currentUser = user
        print("\(currentUser.userName) logged in succsfuly.")
    }
 ...
 */
let aUser = User(userName: "Noura", email: "Noura@friend.com", age: 20)
