 ...
 */
var userNorah = User(name: "Norah", age: 21, height: 155, weight: 42, activityLevel: 7)
print("My name is \(userNorah.name). I am \(userNorah.age) years old, my weight is \(userNorah.weight) kg and my height is  \(userNorah.height) cm. On an activity scale from 1-10 I am probably a \(userNorah.activityLevel).")
 ...
 */
let someDistance = Distance(meters: 2000)
