...
print(RunningWorkout(distance: 4000, time: 1100, elevation: 11).averageMileTime)
/*:
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print("Congratulations! You did it! You met your goal for today!")
            }
        }
    }
    var goal: Int
...
var steps = Steps(steps: 3999, goal: 4000)
steps.takeStep()
