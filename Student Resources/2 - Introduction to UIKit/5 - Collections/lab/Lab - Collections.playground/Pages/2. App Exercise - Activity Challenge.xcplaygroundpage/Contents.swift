...
var runningChallenges: [String] = ["Run 5 times a week", "Run 7 times a week"]
var weightliftingChallenges: [String] = ["Load a bar up with your body weight. Put it on your shoulders, do 50 reps"]
...
if committedChallenges.isEmpty {
    print("please go to commit a challenge")
